  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(13.5, 38.0, 13.0, 18.5),
            child: Stack(
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.fromLTRB(0.0, 635.5, 0.5, 0.0),
                      ...
                      Pinned.fromPins(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Align(
                              alignment: Alignment(0.675, 0.592),
                              child: SizedBox(
                                width: 20.0,
                                height: 12.0,
                            ...
                            Align(
                              alignment: Alignment(-0.594, -0.32),
                              child: SizedBox(
                                width: 20.0,
                                height: 12.0,
                                child: SvgPicture.string(
                            ...
                            Align(
                              alignment: Alignment(-0.613, -0.618),
                              child: SizedBox(
                                width: 30.0,
                                height: 5.0,
                                child: Text(
                            ...
                            children: [
                              ...
                              return SizedBox(
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Align(
                                      alignment: Alignment(-0.132, -0.429),
                                      child: SizedBox(
                                        width: 47.0,
                                        height: 20.0,
                                        child: Text(
