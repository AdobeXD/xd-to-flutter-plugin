  ...
  Pinned.fromSize({
    ...
    Widget? child,
            ...
            Pin(
              ...
              endFraction:
                  !pinRight && !fixedWidth ? (size.width - bounds.right) / size.width : null,
            ...
            Pin(
              ...
              endFraction:
                  !pinBottom && !fixedHeight ? (size.height - bounds.bottom) / size.height : null,
...
class Pin {
  ...
  Pin({this.start, this.startFraction, this.end, this.endFraction, this.size, this.middle})
      : assert(!(start != null && startFraction != null),
        ...
        assert(
            !(end != null && endFraction != null), "Cannot have both end and endFraction values."),
